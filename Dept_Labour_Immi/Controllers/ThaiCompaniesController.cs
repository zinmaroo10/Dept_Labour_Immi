...
namespace Dept_Labour_Immi.Controllers
{
    ...
    public class ThaiCompaniesController : Controller
    {
        ...
        {
            bool isExist = ThaiCompanyExists(thaiCompany.CompanyName);
            string message = "";
            if (!isExist)
            {
            ...
            {
                TempData["Message"] = "The Company Name is already exist";
            }
        ...
        private bool ThaiCompanyExists(string companyName)
        {
            return _context.thaiCompanies.Any(e => e.CompanyName == companyName);
        }
    }
}