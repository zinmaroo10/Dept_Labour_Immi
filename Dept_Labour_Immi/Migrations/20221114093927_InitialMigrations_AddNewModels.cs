...
{
    public partial class InitialMigrations_AddNewModels : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_agencies_bODs_BODID",
                        column: x => x.BODID,
                        principalTable: "bODs",
                        principalColumn: "ID");
                    table.ForeignKey(
                        name: "FK_agencies_thaiCompanies_ThaiCompanyID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_agencies_BODID",
                table: "agencies",
                column: "BODID");

            migrationBuilder.CreateIndex(
                name: "IX_agencies_ThaiCompanyID",
                table: "agencies",
